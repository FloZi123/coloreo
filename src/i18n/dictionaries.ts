...
const de = {
  nav: {
    ...
    bundles: "Bundles",
    bundleBuilder: "Eigenes Paket zusammenstellen",
  ...
  home: {
    ...
    howStep1Title: "Aussuchen & kaufen",
    howStep1Text: "Buch wählen, sicher bezahlen – in unter einer Minute.",
    howStep2Title: "PDF sofort erhalten",
    howStep2Text: "Download-Link direkt nach dem Kauf und per E-Mail.",
    howStep3Title: "Zuhause ausdrucken",
    howStep3Text: "Druckfertiges A4-PDF, beliebig oft – für die ganze Familie.",
    howNoPrinter: "Kein Drucker? Druck dein A4-PDF im Copyshop oder Drogeriemarkt – passt überall.",
    ...
    featureAllAgesDesc: "Von 3 Jahren bis Anti-Stress für Erwachsene.",
...
const en: Dict = {
  nav: {
    ...
    bundles: "Bundles",
    bundleBuilder: "Build your own bundle",
    freebies: "Free pages",
    library: "My Library",
    cart: "Cart",
    help: "Help",
  ...
  home: {
    ...
    howStep1Title: "Pick & buy",
    howStep1Text: "Choose a book and pay securely – in under a minute.",
    howStep2Title: "Get your PDF instantly",
    howStep2Text: "Download link right after purchase and by email.",
    howStep3Title: "Print at home",
    howStep3Text: "Print-ready A4 PDF, as often as you like – for the whole family.",
    howNoPrinter: "No printer? Print your A4 PDF at a copy shop or drugstore – it works anywhere.",
