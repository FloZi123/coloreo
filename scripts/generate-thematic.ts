 ...
 *
 *   npm run gen:thematic                 # alle thematischen Bücher
...
import { imageProviderConfigured, getImageProvider } from "../src/lib/generator/imageProvider";
import { isThematicCategory, generateThematicMasterPdf } from "../src/lib/generator/thematic";
